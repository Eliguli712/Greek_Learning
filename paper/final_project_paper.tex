...
% RISK(HIGH): Manual gold is sampled from the same PROIEL/Perseus test sources used in corpus-scale evaluation; this is in-domain evidence and may overstate out-of-domain generalization.
...
% RISK(HIGH): "Regenerated locally" is not sufficient for full reproducibility; report commit hash, exact commands/flags, Python+package versions, and random seed.
